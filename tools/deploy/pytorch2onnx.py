...
if __name__ == '__main__':
    ...
    cfg = rmsm.Config.fromfile(
        "../../configs/nas/raman_single_cell.py")  # Load the configuration file path，Need to match the input data
    ...
    # loaded model file
    checkpoint = './model/nas/single_cell.pth'
    ...
    pytorch2onnx(
        classifier,
        input_shape,
        output_file='./model/nas/single_cell.onnx',
        opset_version=12,
        show=False,
        dynamic_export=True,
        dimension=True,
