...
的针对于拉曼光谱开源深度学习框架，其可以帮助用户快速进行拉曼光谱深度学习模型训练。本框架已经投稿至Chemometrics and Intelligent Laboratory Systems期刊中。（本框架参考了OpenMMLab项目中的[MMClassification](https://mmclassification.readthedocs.io/zh_CN/latest/)
项目，更加详细的教程可以在其中找到）
