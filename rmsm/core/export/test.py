...
from rmsm.models.classifiers import BaseClassifier
...
class ONNXRuntimeClassifier(BaseClassifier):
    ...
    def simple_test(self, spectrum, ram_metas, **kwargs):
        raise NotImplementedError('This method is not implemented.')

    def extract_feat(self, rams):
        raise NotImplementedError('This method is not implemented.')

    def forward_train(self, rams, **kwargs):
        raise NotImplementedError('This method is not implemented.')

    def forward_test(self, rams, ram_metas, **kwargs):
        input_data = rams
