...
def single_gpu_test(model,
    ...
    for i, data in enumerate(data_loader):
        ...
        if show or out_dir:
            ...
            # For visualization of the results, consider mapping the output spectra（The corresponding fractions and categories are displayed on the spectrogram）
            result_show = {
            ...
            # herespectrumIn theory, it should be the original spectrum
            if show:
