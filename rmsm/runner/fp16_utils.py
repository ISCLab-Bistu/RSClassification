...
from rmsm.utils import IS_NPU_AVAILABLE, TORCH_VERSION, digit_version
...
def auto_fp16(
    ...
    backend, otherwise, original rmsm implementation will be adopted.
...
def force_fp32(apply_to: Optional[Iterable] = None,
    ...
    torch.cuda.amp is used as the backend, otherwise, original rmsm
...
def allreduce_grads(params: List[Parameter],
    ...
    warnings.warn(
        '"rmsm.runner.fp16_utils.allreduce_grads" is deprecated, and will be '
        'removed in v2.8. Please switch to "rmsm.runner.allreduce_grads',
        DeprecationWarning)
