...
'''
    KFoldDataset was used for cross-validation, One of the most commonly used methods
'''
...
class KFoldDataset:
    ...
    def __init__(self,
        ...
        if test_mode == 'test':
            ...
            indices_train = indices[:test_start] + indices[test_end:]
            if test_mode == 'val':
                self.indices = indices_train[0:2 * test_length]
            else:
                self.indices = indices_train[2 * test_length:]
