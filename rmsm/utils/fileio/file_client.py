...
import rmsm
from rmsm.utils.misc import has_method
from rmsm.utils.path import is_filepath
...
class PetrelBackend(BaseStorageBackend):
    ...
    def _format_path(self, filepath: str) -> str:
        ...
        's3://bucket_name\data.jpg'. By invoking :meth:`_format_path`, the
        above ``filepath`` will be converted to 's3://bucket_name/data.jpg'.
...
class HardDiskBackend(BaseStorageBackend):
    ...
    def put(self, obj: bytes, filepath: Union[str, Path]) -> None:
        ...
        Args:
            ...
            filepath (str or Path): Path to write data.
        """
        rmsm.mkdir_or_exist(osp.dirname(filepath))
