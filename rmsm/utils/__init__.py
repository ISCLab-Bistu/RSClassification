...
from .distribution import wrap_non_distributed_model, wrap_distributed_model
...
try:
    ...
    __all__ = [
        ...
        'is_method_overridden', 'has_method', 'collect_env', 'get_root_logger', 'load_json_log',
        'setup_multi_processes', 'wrap_non_distributed_model', 'auto_select_device', 'wrap_distributed_model',
    ]
else:
    ...
    __all__ = [
        ...
        'wrap_non_distributed_model', 'auto_select_device', 'wrap_distributed_model',
    ]
