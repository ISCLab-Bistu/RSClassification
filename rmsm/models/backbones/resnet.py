...
from rmsm.cnn import (ConvModule, build_activation_layer, build_conv_layer,
                      build_norm_layer, constant_init)
from rmsm.cnn.bricks import DropPath
from rmsm.runner import BaseModule
from rmsm.utils.parrots_wrapper import _BatchNorm
...
class ResNet(BaseBackbone):
    ...
    Args:
        ...
        in_channels (int): Number of input raman data channels. Default: 3.
