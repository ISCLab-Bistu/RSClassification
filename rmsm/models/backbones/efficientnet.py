...
from rmsm.cnn.bricks import ConvModule, DropPath
from rmsm.runner import BaseModule, Sequential

from rmsm.models.backbones.base_backbone import BaseBackbone
from rmsm.models.utils import InvertedResidual, SELayer, make_divisible
...
class EfficientNet(BaseBackbone):
    ...
    Args:
        ...
        conv_cfg (dict): Config dict for convolution layer.
            Defaults to None, which means using conv1d.
