...
from rmsm.utils import Registry, build_from_cfg, get_logger, print_log
...
class PretrainedInit:
    ...
    def __call__(self, module: nn.Module) -> None:
        from rmsm.runner import (_load_checkpoint_with_prefix, load_checkpoint,
                                 load_state_dict)
        logger = get_logger('rmsm')
