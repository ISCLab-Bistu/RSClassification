...
from rmsm.runner import build_optimizer
from rmsm.runner.optimizer.builder import OPTIMIZERS
from rmsm.utils.registry import build_from_cfg
from torch.autograd import Variable
from torch.optim.optimizer import Optimizer

import rmsm.core  # noqa: F401
...
class SubModel(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.conv1 = nn.Conv1d(2, 2, kernel_size=1, groups=2)
...
class ExampleModel(nn.Module):
    ...
    def __init__(self):
        super().__init__()
        self.param1 = nn.Parameter(torch.ones(1))
        self.conv1 = nn.Conv1d(3, 4, kernel_size=1, bias=False)
        self.conv2 = nn.Conv1d(4, 2, kernel_size=1)
